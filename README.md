...
P0 (foundation), P1 (shell-as-config), P2 (agent loop), and **P3 (Theme Manager — global + per-frame themes)** are live. Doctrine for the agent boundary lives in [`AGENTS.md`](AGENTS.md).
